            ...
            <nav>
                <div className='wrapper'>
                    ...
                    <ul className='navlinks'>
                        <li><a style={{ fontSize: "40px", fontWeight: "800", color: "#fc2779" }} onClick={()=>navigate('/')} className='logo' href="#">VEYA</a></li>
                    ...
                    <div className='inputSection'>
                        <div className='searchDiv'>
                            ...
                            <input onKeyDown={handleKeyDown}  onChange={handleInputChange} className='search' placeholder='Search on veya' type="text" />
                                    ...
                                    <div className="mega-box2">
                                        <div className="content">
                                            ...
                                            <div className="row">
                                                ...
                                                <div>
                                                    <p style={{ opacity: "0.6" }}>Register now and get 2000 Veya reward points</p>
